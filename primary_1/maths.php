  ...
  <section id="sidebar">
     <div class="container-fluid">
        <div class="row content ">
          ...
          <div class="col-md-10">
            <div id="main">
              <center><img src="../img/math.png"  style="width: 40%;"></center>
              <h2 id="text" style="display: none;">WELCOME TO OUR MATHS LESSONS</h2>
              <h5 id="text2" style="display: none;">Relax kid, while we get all lessons ready for you. </h5> 
...
addScene('example:<h2>WELCOME TO OUR MATHS LESSONS</h2> ', 600);
 theater.
addActor('example2', { speed: 1.2, accuracy: 0.9 }).
addScene('example2: <h5>Relax kid, while we get all lessons ready for you.</h5>', 400);
 theater.
addActor('example4', { speed: 0.8, accuracy: 1.5 }).
addScene('example4: <center>  <a href="maths_1.php"><button class="btn btn-warning">Click here to Start <span class="fa fa-chevron-circle-right"></span></button></a> <a href="math_dynamic.php"><button class="btn btn-warning"><span class="fa fa-chevron-circle-left"></span> Jump to Dynamic Lessons</button> </center>', 400);
</script>
