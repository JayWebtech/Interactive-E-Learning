        ...
        <div class="row content ">
          ...
          <div class="col-md-10">
            <div id="main">
              ...
              <h2 id="text" style="display: none;">WELCOME TO OUR COMPUTER LESSONS</h2>
              <h5 id="text2" style="display: none;">You will get to know all about Computer in a interactive and comfortable way.</h5> 
...
addScene('example:<h2>WELCOME TO OUR COMPUTER LESSONS</h2> ', 600);
 theater.
addActor('example2', { speed: 1.2, accuracy: 0.9 }).
addScene('example2: <h5>You will get to know all about Computer in a interactive and comfortable way.</h5>', 400);
 theater.
addActor('example4', { speed: 0.8, accuracy: 1.5 }).
addScene('example4: <center>  <a href="cintro.php"><button class="btn btn-warning">Click here to start. <span class="fa fa-chevron-circle-right"></span></button></a> <a href="com_dynamic.php"><button class="btn btn-warning"><span class="fa fa-chevron-circle-left"></span> Jump to Dynamic Lessons</button> </center>', 400);
</script>
