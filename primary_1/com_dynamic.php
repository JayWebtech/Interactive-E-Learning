...
<body>
  ...
  $result_count = mysqli_query($dbcon,"SELECT COUNT(*) As total_records FROM `computer` WHERE class = 'Primary 1'");
  ...
  $second_last = $total_no_of_pages - 1; // total page minus 1
    ...
    $result = mysqli_query($dbcon,"SELECT * FROM `computer` WHERE class = 'Primary 1' ORDER BY id DESC LIMIT $offset, $total_records_per_page");
